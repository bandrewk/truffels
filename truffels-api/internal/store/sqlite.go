...
func (s *Store) migrate() error {
	migrations := []string{"migrations/001_init.sql", "migrations/002_auth.sql", "migrations/003_updates.sql", "migrations/004_monitoring.sql", "migrations/005_fan_metrics.sql"}
