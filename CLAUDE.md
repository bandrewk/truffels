...
- **Installation:** `install.sh` prompts for pruning mode (full node or pruned, env var `TRUFFELS_PRUNE_SIZE` for non-interactive). INSTALLATION.md completed through step 20 (update system)
